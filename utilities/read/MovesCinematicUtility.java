...
public class MovesCinematicUtility {
    ...
    // PvE
    private static final ArrayList<Double>
            pvePower = new ArrayList<>();
    private static final ArrayList<Integer>
            pveDurationMs = new ArrayList<>();
    ...
    private static final ArrayList<Byte>
            pveEnergy = new ArrayList<>();

    // PvP
    private static final ArrayList<Double>
            pvpPower = new ArrayList<>(),
            pvpBuffChance = new ArrayList<>();

    private static final ArrayList<Byte>
            pvpEnergy = new ArrayList<>(),
    ...
    public MovesCinematicUtility(int moveNum, String moveName, String moveType, Double pvePower, Byte pveEnergy,
                                 int pveDurationMs, int pveDamageWindowStartMs, int pveDamageWindowEndMs,
    ...
    public static String printInfo(int counter) {
        return "\nCinematic Moves-----------------------------" +
                "\nMove Num: " + getMoveNum().get(counter) +
                "\nMove Name: " + getMoveName().get(counter) +
                "\nMove Type: " + getMoveType().get(counter) +
                "\n" +
                "\nPvE Power: " + getPvePower().get(counter) +
                "\nPvE Energy: " + getPveEnergy().get(counter) +
                "\nPvE Duration ms: " + getPveDurationMs().get(counter) +
                "\nPvE Damage Window Start ms: " + getPveDamageWindowStartMs().get(counter) +
                "\nPvE Damage Window End ms: " + getPveDamageWindowEndMs().get(counter) +
                "\n" +
                "\nPvP Power: " + getPvpPower().get(counter) +
                "\nPvP Energy: " + getPvpEnergy().get(counter) +
                "\nPvP Buff Chance: " + getPvpBuffChance().get(counter) +
                "\nPvP Buff A/A: " + getPvpBuffAttackerAttack().get(counter) +
                "\nPvP Buff A/D: " + getPvpBuffAttackerDefense().get(counter) +
                "\nPvP Buff T/A: " + getPvpBuffTargetAttack().get(counter) +
                "\nPvP Buff T/D: " + getPvpBuffAttackerDefense().get(counter);
    }
