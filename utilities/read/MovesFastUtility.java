...
public class MovesFastUtility {
    ...
    public MovesFastUtility(int moveNum, String moveName, String moveType, Double pvePower, Byte pveEnergy,
                            int getPveDamageWindowStartMs, int getPveDamageWindowEndMs, Double pvpPower,
                            Byte pvpEnergy, Byte pvpTurns) {
    ...
    public static String printInfo(int counter) {
        return "\nQuick Moves---------------------------------" +
                ...
                "\nPvP Turns: " + getPvpTurns().get(counter);
    }
